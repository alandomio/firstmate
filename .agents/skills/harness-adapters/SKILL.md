...
A profile may also opt a claude dispatch into a per-turn advisor axis; `docs/configuration.md` "Crew dispatch profiles" owns that schema and `bin/fm-advisor-hook.sh` owns the reviewer mechanism.
