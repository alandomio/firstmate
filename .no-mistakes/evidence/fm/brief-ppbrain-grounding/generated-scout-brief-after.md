...
4. Report status by appending one line:
   `echo "{state}: {one short line}" >> '/tmp/fm-brief-evidence.0YbBOD/after-home/state/scout-demo.status'`
...
# Definition of done
Write your findings to `/tmp/fm-brief-evidence.0YbBOD/after-home/data/scout-demo/report.md`.
