...
4. Report status by appending one line:
   ...
   cadence instead of treating it as a possible wedge. Use `blocked:` when you are stuck and need help. If a declared wait concerns an open PR/MR under review, describe it as awaiting a colleague's approval, never the captain's merge decision - the captain cannot approve their own pull/merge request.
