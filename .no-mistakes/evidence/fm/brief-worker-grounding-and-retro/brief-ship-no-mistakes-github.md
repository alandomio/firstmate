...
1. First action: create your branch: `git checkout -b fm/ev-ship-nomistakes`
...
4. Report status by appending one line:
   `echo "{state}: {one short line}" >> '/tmp/fm-brief-evidence/home/state/ev-ship-nomistakes.status'`
